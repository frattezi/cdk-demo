import { DockerImageDestination, DockerImageSource, FileDestination, FileSource, ManifestFile } from '@aws-cdk/cdk-assets-schema';
/**
...
export declare class AssetManifest {
    ...
    constructor(directory: string, manifest: ManifestFile);
    /**
